                    ...
                    child: Column(
                      children: [
                        AddPhotoButton(
                          text: 'Take Photo',
                          function: () {
                            AddPatientCubit.get(context).pickImageFromCamera();
                          },
                    ...
                    child: Column(
                      children: [
                        AddPhotoButton(
                          text: 'Add Photos',
                          function: () {
                            AddPatientCubit.get(context).pickImageFromGallery();
                          },
                    ...
                    return button(
                      ...
                      function: () {
                        ...
                        if (formKey.currentState!.validate()) {
                          if (injuryRegion == null || suspectedInjury == null) {
                            showToast(
                                text:
                            ...
                            AddPatientCubit.get(context).uploadRadiologyImages(
                              patientId: int.parse(iDController.text),
                            );
