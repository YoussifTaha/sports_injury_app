...
import 'package:sports_injury_app/features/bag/ui/widgets/bag_expanded_list.dart';
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              verticalSpace(10),
              BagListWidget(
                choice: 'Medication cream and gel',
                icon: 'cream',
                detailsTitle: [
              ...
              BagListWidget(
                ...
                detailsTitle: [
                  ...
                  'Antibiotic spray',
                  'Dressing spray',
                  'Oral anti-fungal spray',
                  'Anesthetic spray',
                  'Wound healing promoter spray',
                ],
              ),
              verticalSpace(10),
              BagListWidget(
              ...
              BagListWidget(
                ...
                detailsTitle: [
                  ...
                  'TUE',
                  'WADA list',
                  'List of players and officials with allergies',
                  'Light pen',
                ],
              ),
              verticalSpace(10),
